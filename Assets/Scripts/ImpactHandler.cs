...
namespace intheclouds
{
    public class ImpactHandler : HVRDamageProvider
    {
        ...
        private void HandleSwipeSFX()
        {
            ...
            {
                var relativeVelocity = Mathf.Abs(_grabbable.Rigidbody.velocity.magnitude - LocalUserObjects.instance.PlayerController.CharacterController.velocity.magnitude);
